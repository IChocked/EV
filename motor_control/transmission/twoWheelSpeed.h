...
void twoWheelSpeed(double wheelRatio, int throttleRead, int *leftPWM, int *rightPWM, byte currRightSpeed,
                   byte currLeftSpeed, byte *prevError, bool leftFast, Ramp *ramp)
{
    byte currFastSpeed;
    byte currSlowSpeed;
