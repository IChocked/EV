...
void setup() {
  ...
  if (imu.begin() == false) // with no arguments, this uses default addresses
  ...
  // myPressure.setModeBarometer(); // Measure pressure in Pascals from 20 to
  // 110 kPa
